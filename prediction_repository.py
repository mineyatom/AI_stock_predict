...
def update_prediction_ai_summary(
    predict_date,
    stock_code,
    ai_summary,
):
...
def get_stock_accuracy_stats_from_db() -> list:
    ...
    try:
        ...
        for prediction in predictions:
            ...
            stock_stats[stock_code]["total"] += 1



            if prediction.is_correct == "正確":

                stock_stats[stock_code]["correct"] += 1
...
def get_accuracy_chart_data_from_db() -> dict:
    ...
    try:
        ...
        for prediction in predictions:
            ...
            daily_stats[predict_date]["total"] += 1



            if prediction.is_correct == "正確":

                daily_stats[predict_date]["correct"] += 1
